...
var $recentAdded = document.querySelector('#recent-added-container');
  ...
  methods: {
    boot: function boot() {
      ...
      axios.get('/api/settings').then(function (response) {
        ...
        if (_this.settings.plex_service) {
          _this.startSockets();

          localStorage.setItem('plexIpAddress', _this.settings.plex_ip_address);
          localStorage.setItem('plexToken', _this.settings.plex_token);
        }

        _this.getMoviePosters();
    ...
    getMoviePosters: function getMoviePosters() {
      var _this2 = this;

      this.stopTransitionImages();
      axios.get('/api/posters?show_in_rotation=true').then(function (response) {
        ...
        if (_this2.moviePosters.length === 0) {
          ...
          if (_this2.settings.random_order) {
            ...
            if (_this2.moviePosters[rand].trailer_path && _this2.moviePosters[rand].show_trailer) {
              _this2.playTrailer(_this2.moviePosters[rand].trailer_path);
            }

            if (_this2.moviePosters[rand].show_runtime) {
              _this2.runtime = _this2.moviePosters[rand].runtime;
            }
          } else {
            ...
            if (_this2.moviePosters[0].trailer_path && _this2.moviePosters[0].show_trailer) {
              _this2.playTrailer(_this2.moviePosters[0].trailer_path);
            }

            if (_this2.moviePosters[0].show_runtime) {
              _this2.runtime = _this2.moviePosters[0].runtime;
            }
          }
    ...
    cachePosters: function cachePosters() {
      var _this3 = this;

      axios.get('/api/cache-posters').then(function (response) {
        _this3.moviePosters = response.data.posters;
        setTimeout(function () {
          if (_this3.loading === true) {
            _this3.loading = false;

            _this3.startTransitionImages();
          }
        }, 5000);
      })["catch"](function (e) {
        console.log(e.message);
    ...
    getNowPlaying: function getNowPlaying() {
      ...
      _services_api__WEBPACK_IMPORTED_MODULE_0__["default"].apiCallPlex('/status/sessions/').then(function (response) {
        var size = response.data.MediaContainer.size;
    ...
    transitionImages: function transitionImages() {
      var poster = '';
      var activeIndex = 0;
      ...
      if (this.moviePosters.length > 0) {
        if (this.settings.random_order) {
          this.moviePosters.forEach(function (item) {
            if (item.show) {
              item.show = false;
            }
          });
          poster = this.moviePosters[Math.floor(Math.random() * this.moviePosters.length)];
        } else {
          var len = this.moviePosters.length;
          var currItem = this.moviePosters.filter(function (e, i) {
            return e.show === true;
          });
          var currIndex = this.moviePosters.indexOf(currItem[0]);
    ...
    startTransitionImages: function startTransitionImages() {
      ...
      this.transitionImagesInterval = setInterval(function () {
        _this5.transitionImages();
      }, this.settings.poster_display_speed);
    },
    stopTransitionImages: function stopTransitionImages() {
      clearInterval(this.transitionImagesInterval);
    },
    controlTV: function controlTV(command) {
      if (this.settings.user_cec_power) {
        ...
        axios.get('/api/control-display/' + command).then(function () {})["catch"](function (e) {
          console.log(e.message);
        });
      }
    },
    controlPlayerState: function controlPlayerState(state) {
      switch (state) {
        case 'playing':
    ...
    playTrailer: function playTrailer(youTubeId) {
      console.log('PLAY TRAILER');
      this.iframeEl = document.createElement('iframe');
      this.iframeEl.setAttribute('src', "https://www.youtube.com/embed/".concat(youTubeId, "?enablejsapi=1&autoplay=1&mute=1&autohide=2&modestbranding=1&showinfo=0&controls=0&rel=0&border=0&wmode=opaque"));
    ...
    isOnTime: function isOnTime() {
      ...
      var date1 = new Date(month + '/' + day + '/' + year + ' ' + this.settings.start_power_time);
      var date2 = new Date(month + '/' + day + '/' + year + ' ' + this.settings.end_power_time);

      if (presentDate.getTime() > date1.getTime() && presentDate.getTime() < date2.getTime()) {
        return true;
      } else {
        return false;
      }
    ...
    startSockets: function startSockets() {
      var _this6 = this;

      var socket = new WebSocket('ws://' + this.settings.plex_ip_address + ':32400/:/websockets/notifications' + '?X-Plex-Token=' + this.settings.plex_token);
      socket.addEventListener('open', function () {});
      socket.addEventListener('message', function (event) {
        var data = JSON.parse(event.data);
        var action = data.NotificationContainer.type;

        if (action === 'playing') {
          var state = data.NotificationContainer.PlaySessionStateNotification[0].state;
          console.log(state); // playing || stopped

          _this6.controlPlayerState(state);
        }
      });
    },
    ...
    gotoPosters: function gotoPosters() {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getPosters: function getPosters() {
      ...
      axios.get('/api/posters').then(function (response) {
    ...
    deletePoster: function deletePoster(poster) {
      var _this3 = this;

      var params = {
        _method: 'delete'
      };
      axios.post('/api/posters/' + poster.id, params).then(function (response) {
        _this3.posters.splice(_this3.posters.indexOf(poster), 1);
      })["catch"](function (e) {
        console.log(e.message);
      });
    },
    ...
    onDragEnd: function onDragEnd(e) {
      ...
      this.debounce = setTimeout(function (params) {
        this.debounce = false;
        axios.post('/api/posters-sort/', {
          items: params
        }).then(function (response) {//this.posters response.data.posters;
        })["catch"](function (e) {
          console.log(e.message);
        });
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/PostersEdit.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/PostersEdit.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getPoster: function getPoster(id) {
      ...
      axios.get('/api/posters/' + id).then(function (response) {
        _this.poster = response.data.poster;
      })["catch"](function (e) {
        console.log(e.message);
      });
    },
    ...
    savePoster: function savePoster() {
      ...
      axios.post(url, params).then(function (response) {
        _this2.saving = false;
        _this2.savePosterBtn = 'Saved Poster!';
        _this2.poster = response.data.poster;
        _this2.mode = 'edit';
        setTimeout(function () {
          _this2.savePosterBtn = 'Save Poster';
        }, 3000);
      })["catch"](function (e) {
        console.log(e.message);
        _this2.saving = false;
        ...
        _this2.formMessage = e.response.data.message;
      });
    },
...
/* harmony import */ var _Views_Settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Views/Settings */ "./resources/js/Views/Settings.vue");
/* harmony import */ var _Views_Posters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Views/Posters */ "./resources/js/Views/Posters.vue");
/* harmony import */ var _Views_PostersEdit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Views/PostersEdit */ "./resources/js/Views/PostersEdit.vue");
...
var routes = [{
  ...
  path: '/posters',
  name: 'Posters',
  component: _Views_Posters__WEBPACK_IMPORTED_MODULE_2__["default"]
}, {
  path: '/posters/:id',
  name: 'PostersEdit',
  component: _Views_PostersEdit__WEBPACK_IMPORTED_MODULE_3__["default"]
}];
...
var Api = /*#__PURE__*/function (_Service) {
  ...
  _createClass(Api, [{
    key: "apiCallPlex",
    value: function apiCallPlex() {
      var route = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '/';
      var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var baseUrl = 'http://' + localStorage.getItem('plexIpAddress') + ':32400';
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Dashboard.vue?vue&type=style&index=0&lang=scss&":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Dashboard.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=style&index=0&lang=scss&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Dashboard.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Dashboard.vue?vue&type=style&index=0&lang=scss&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Posters_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Posters.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=style&index=0&lang=scss&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Posters_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Dashboard_vue_vue_type_template_id_3af6da65___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Dashboard.vue?vue&type=template&id=3af6da65& */ "./resources/js/Views/Dashboard.vue?vue&type=template&id=3af6da65&");
/* harmony import */ var _Dashboard_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Dashboard.vue?vue&type=script&lang=js& */ "./resources/js/Views/Dashboard.vue?vue&type=script&lang=js&");
/* harmony import */ var _Dashboard_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Dashboard.vue?vue&type=style&index=0&lang=scss& */ "./resources/js/Views/Dashboard.vue?vue&type=style&index=0&lang=scss&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Dashboard_vue_vue_type_template_id_3af6da65___WEBPACK_IMPORTED_MODULE_0__.render,
  _Dashboard_vue_vue_type_template_id_3af6da65___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/***/ "./resources/js/Views/Posters.vue":
/*!****************************************!*\
  !*** ./resources/js/Views/Posters.vue ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Posters_vue_vue_type_template_id_6a6cadd7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Posters.vue?vue&type=template&id=6a6cadd7& */ "./resources/js/Views/Posters.vue?vue&type=template&id=6a6cadd7&");
/* harmony import */ var _Posters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Posters.vue?vue&type=script&lang=js& */ "./resources/js/Views/Posters.vue?vue&type=script&lang=js&");
/* harmony import */ var _Posters_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Posters.vue?vue&type=style&index=0&lang=scss& */ "./resources/js/Views/Posters.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _Posters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _Posters_vue_vue_type_template_id_6a6cadd7___WEBPACK_IMPORTED_MODULE_0__.render,
  _Posters_vue_vue_type_template_id_6a6cadd7___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/Views/Posters.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _PostersEdit_vue_vue_type_template_id_6f9eb381___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PostersEdit.vue?vue&type=template&id=6f9eb381& */ "./resources/js/Views/PostersEdit.vue?vue&type=template&id=6f9eb381&");
/* harmony import */ var _PostersEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PostersEdit.vue?vue&type=script&lang=js& */ "./resources/js/Views/PostersEdit.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _PostersEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _PostersEdit_vue_vue_type_template_id_6f9eb381___WEBPACK_IMPORTED_MODULE_0__.render,
  _PostersEdit_vue_vue_type_template_id_6f9eb381___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/Views/PostersEdit.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Settings_vue_vue_type_template_id_4e949a3c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Settings.vue?vue&type=template&id=4e949a3c& */ "./resources/js/Views/Settings.vue?vue&type=template&id=4e949a3c&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Settings_vue_vue_type_template_id_4e949a3c___WEBPACK_IMPORTED_MODULE_0__.render,
  _Settings_vue_vue_type_template_id_4e949a3c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/***/ "./resources/js/Views/Posters.vue?vue&type=script&lang=js&":
/*!*****************************************************************!*\
  !*** ./resources/js/Views/Posters.vue?vue&type=script&lang=js& ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Posters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Posters.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Posters_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/Views/PostersEdit.vue?vue&type=script&lang=js&":
/*!*********************************************************************!*\
  !*** ./resources/js/Views/PostersEdit.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PostersEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./PostersEdit.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/PostersEdit.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PostersEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Dashboard.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Dashboard.vue?vue&type=style&index=0&lang=scss&");


/***/ }),

/***/ "./resources/js/Views/Posters.vue?vue&type=style&index=0&lang=scss&":
/*!**************************************************************************!*\
  !*** ./resources/js/Views/Posters.vue?vue&type=style&index=0&lang=scss& ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Posters_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Posters.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=style&index=0&lang=scss&");
...
/***/ "./resources/js/Views/Dashboard.vue?vue&type=template&id=3af6da65&":
/*!*************************************************************************!*\
  !*** ./resources/js/Views/Dashboard.vue?vue&type=template&id=3af6da65& ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_template_id_3af6da65___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_template_id_3af6da65___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_template_id_3af6da65___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Dashboard.vue?vue&type=template&id=3af6da65& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Dashboard.vue?vue&type=template&id=3af6da65&");


/***/ }),

/***/ "./resources/js/Views/Posters.vue?vue&type=template&id=6a6cadd7&":
/*!***********************************************************************!*\
  !*** ./resources/js/Views/Posters.vue?vue&type=template&id=6a6cadd7& ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Posters_vue_vue_type_template_id_6a6cadd7___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Posters_vue_vue_type_template_id_6a6cadd7___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Posters_vue_vue_type_template_id_6a6cadd7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Posters.vue?vue&type=template&id=6a6cadd7& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=template&id=6a6cadd7&");


/***/ }),

/***/ "./resources/js/Views/PostersEdit.vue?vue&type=template&id=6f9eb381&":
/*!***************************************************************************!*\
  !*** ./resources/js/Views/PostersEdit.vue?vue&type=template&id=6f9eb381& ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PostersEdit_vue_vue_type_template_id_6f9eb381___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PostersEdit_vue_vue_type_template_id_6f9eb381___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PostersEdit_vue_vue_type_template_id_6f9eb381___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./PostersEdit.vue?vue&type=template&id=6f9eb381& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/PostersEdit.vue?vue&type=template&id=6f9eb381&");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Settings_vue_vue_type_template_id_4e949a3c___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Settings_vue_vue_type_template_id_4e949a3c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Settings_vue_vue_type_template_id_4e949a3c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Settings.vue?vue&type=template&id=4e949a3c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Settings.vue?vue&type=template&id=4e949a3c&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Dashboard.vue?vue&type=template&id=3af6da65&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Dashboard.vue?vue&type=template&id=3af6da65& ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    [
      ...
      !_vm.nowPlaying
        ? _c(
            "div",
            {
              attrs: { id: "recent-added-container" },
              on: {
                click: function($event) {
              ...
              _c("div", { staticClass: "recent-poster-container" }, [
                _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("div", { attrs: { id: "trailer" } }, [
                      _c("div", {
                        ref: "videoPlayer",
                        attrs: { id: "youtube-player" }
                      })
                    ])
                  ],
                  2
                  ...
                  ? _c("div", { staticClass: "dolby-logos" }, [
                      _vm.settings.show_imax
                        ? _c("div", [
                            _c("img", {
                              staticClass: "imax",
                              attrs: { src: "/images/imax.png", alt: "IMAX" }
                            })
                          ])
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.settings.show_auro_3d
                        ? _c("div", [
                            _vm.settings.show_auro_3d
                              ? _c("img", {
                                  staticClass: "auro3d",
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.settings.show_dolby_vision_horizontal
                        ? _c("div", [
                            _c("img", {
                              staticClass: "dolby-vision",
                              attrs: {
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.settings.show_dolby_atmos_horizontal
                        ? _c("div", [
                            _c("img", {
                              staticClass: "dolby-atmos",
                              attrs: {
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.settings.show_dolby_vision_vertical
                        ? _c("div", [
                            _c("img", {
                              staticClass: "dolby-vision-stacked",
                              attrs: {
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.settings.show_dolby_atmos_vertical
                        ? _c("div", [
                            _c("img", {
                              staticClass: "dolby-atmos-stacked",
                              attrs: {
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.settings.show_dts
                        ? _c("div", [
                            _c("img", {
                              staticClass: "dts",
                              attrs: { src: "/images/dts-x.svg", alt: "DTS" }
                            })
                          ])
                        : _vm._e()
                    ])
      ...
      _c("transition", { attrs: { name: "fade", mode: "out-in" } }, [
        _vm.nowPlaying
          ? _c(
              "div",
              {
                attrs: { id: "now-playing-container" },
                on: {
                  click: function($event) {
                    $event.preventDefault()
                    return _vm.gotoPosters()
              ...
              [
                _c("header", { staticClass: "now-playing-header" }, [
                  _c("h1", [_vm._v(_vm._s(_vm.settings.now_playing_text))])
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "now-playing-container" }, [
                  _c("div", {
                    staticClass: "now-playing-poster",
                    style: "background-image: url(" + _vm.nowPlayingPoster + ")"
                  })
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "now-playing-footer" }, [
                  _vm.settings.show_mpaa_rating
                    ? _c("div", { staticClass: "content-rating" }, [
                        _vm.contentRating
                          ? _c("img", {
                              attrs: {
                                src: "/images/" + _vm.contentRating + ".svg",
                                alt: "Content Rating"
                              }
                            })
                          : _vm._e()
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=template&id=6a6cadd7&":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Posters.vue?vue&type=template&id=6a6cadd7& ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          _c("div", { staticClass: "grid lg:grid-cols-12 gap-4" }, [
            _c("div", { staticClass: "lg:col-span-2" }, [
              _c(
                "ul",
                {
                  staticClass: "block text-gray-300 p-4 sticky top-0",
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "router-link",
                        {
                          staticClass: "hover:text-gray-500 active",
                          attrs: { to: "/posters" }
                        },
                        [_vm._v("Posters")]
                      )
            ...
            _c(
              ...
              [
                      ...
                      _c(
                        "a",
                        {
                          ...
                          on: {
                            click: function($event) {
                              $event.preventDefault()
                              return _vm.cachePosters.apply(null, arguments)
                            }
                          }
                        },
                        [
                ...
                _vm._v(" "),
                _vm.recaching
                  ? _c("div", { staticClass: "cache-overlay" }, [
                      _c("span", [_vm._v("Caching Posters ...")])
                    ])
                  : _vm._e(),
                _vm._v(" "),
                _c(
                  ...
                  _vm._l(_vm.posters, function(poster) {
                    return _c(
                      "div",
                      {
                        key: poster.id,
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/PostersEdit.vue?vue&type=template&id=6f9eb381&":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/PostersEdit.vue?vue&type=template&id=6f9eb381& ***!
  \******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                  ...
                  _c("div", { staticClass: "lg:col-span-4" }, [
                    _vm.mode === "edit" && _vm.poster.file_name
                      ? _c("img", {
                          ...
                          attrs: {
                            src: "/storage/posters/" + _vm.poster.file_name,
                            alt: "Poster"
                          }
                        })
                      : _vm._e()
                  ...
                  _c("div", { staticClass: "lg:col-span-8" }, [
                    _c("div", { staticClass: "mb-5" }, [
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.poster.imdb_id,
                            expression: "poster.imdb_id"
                          }
                        ],
                        ...
                        domProps: { value: _vm.poster.imdb_id },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(_vm.poster, "imdb_id", $event.target.value)
                          }
                        }
                      }),
                      _vm._v(" "),
                    ...
                    _vm._v(" "),
                    _c("hr", { staticClass: "border-grey-500 mb-5" }),
                    _vm._v(" "),
                    _c("div", { staticClass: "mb-5" }, [
                      _c(
                        "label",
                    ...
                    _c("div", { staticClass: "mb-5" }, [
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.poster.runtime,
                            expression: "poster.runtime"
                          }
                        ],
                        staticClass: "text-black w-full",
                        attrs: {
                        ...
                        domProps: { value: _vm.poster.runtime },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(_vm.poster, "runtime", $event.target.value)
                          }
                        }
                      })
                    ]),
                      ...
                      _c(
                        ...
                        [
                          _c("input", {
                            ...
                            attrs: { type: "checkbox" },
                            domProps: {
                              checked: Array.isArray(_vm.poster.show_trailer)
                                ? _vm._i(_vm.poster.show_trailer, null) > -1
                                : _vm.poster.show_trailer
                            },
                            on: {
                              change: function($event) {
                                var $$a = _vm.poster.show_trailer,
                                  $$el = $event.target,
                                  $$c = $$el.checked ? true : false
                                if (Array.isArray($$a)) {
                                  var $$v = null,
                                  ...
                                  _vm.$set(_vm.poster, "show_trailer", $$c)
                                }
                              }
                            }
                          }),
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.poster.show_runtime,
                                expression: "poster.show_runtime"
                              }
                            ],
                            staticClass: "text-black",
                            attrs: { type: "checkbox" },
                            domProps: {
                              checked: Array.isArray(_vm.poster.show_runtime)
                                ? _vm._i(_vm.poster.show_runtime, null) > -1
                                : _vm.poster.show_runtime
                            },
                            on: {
                              change: function($event) {
                                var $$a = _vm.poster.show_runtime,
                                  $$el = $event.target,
                                  $$c = $$el.checked ? true : false
                                if (Array.isArray($$a)) {
                                  var $$v = null,
                                  ...
                                  _vm.$set(_vm.poster, "show_runtime", $$c)
                                }
                              }
                            }
                          }),
                      ...
                      _c(
                        ...
                        [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.poster.show_in_rotation,
                                expression: "poster.show_in_rotation"
                              }
                            ],
                            staticClass: "text-black",
                            ...
                            domProps: {
                              checked: Array.isArray(
                                _vm.poster.show_in_rotation
                              )
                                ? _vm._i(_vm.poster.show_in_rotation, null) > -1
                                : _vm.poster.show_in_rotation
                            },
                            on: {
                              change: function($event) {
                                var $$a = _vm.poster.show_in_rotation,
                                  $$el = $event.target,
                                  $$c = $$el.checked ? true : false
                                if (Array.isArray($$a)) {
                                  var $$v = null,
                                  ...
                                  _vm.$set(_vm.poster, "show_in_rotation", $$c)
                                }
                              }
                            }
                          }),
                    ...
                    _c(
                      "button",
                      {
                        ...
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            return _vm.savePoster.apply(null, arguments)
                          }
                        }
                      },
                      [
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Settings.vue?vue&type=template&id=4e949a3c&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Views/Settings.vue?vue&type=template&id=4e949a3c& ***!
  \***************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                _c("form", [
                  ...
                  _c("div", { staticClass: "mb-5" }, [
                    _c(
                      ...
                      {
                        staticClass: "text-gray-300 block mb-2 font-bold",
                        attrs: { for: "ip-address" }
                      },
                      [_vm._v("Plex Server IP Address")]
                    ),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.settings.plex_ip_address,
                          expression: "settings.plex_ip_address"
                        }
                      ],
                      staticClass: "text-black w-full",
                      attrs: {
                      ...
                      domProps: { value: _vm.settings.plex_ip_address },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _c("div", { staticClass: "mb-5" }, [
                    ...
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.settings.plex_token,
                          expression: "settings.plex_token"
                        }
                      ],
                      staticClass: "text-black w-full",
                      attrs: {
                      ...
                      domProps: { value: _vm.settings.plex_token },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _c("div", { staticClass: "mb-5" }, [
                    _c(
                      ...
                      {
                        staticClass: "text-gray-300 block mb-2 font-bold",
                        attrs: { for: "display-speed" }
                      },
                      [_vm._v("Poster Display Speed")]
                    ),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.settings.poster_display_speed,
                          expression: "settings.poster_display_speed"
                        }
                      ],
                      staticClass: "text-black w-full",
                      attrs: {
                      ...
                      domProps: { value: _vm.settings.poster_display_speed },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _c("div", { staticClass: "mb-5" }, [
                    _c(
                      ...
                      {
                        staticClass: "text-gray-300 block mb-2 font-bold",
                        attrs: { for: "coming-soon-text" }
                      },
                      [_vm._v("Coming Soon Text")]
                    ),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.settings.coming_soon_text,
                          expression: "settings.coming_soon_text"
                        }
                      ],
                      staticClass: "text-black w-full",
                      attrs: {
                      ...
                      domProps: { value: _vm.settings.coming_soon_text },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _c("div", { staticClass: "mb-5" }, [
                    _c(
                      ...
                      {
                        staticClass: "text-gray-300 block mb-2 font-bold",
                        attrs: { for: "now-playing-text" }
                      },
                      [_vm._v("Now Playing Text")]
                    ),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.settings.now_playing_text,
                          expression: "settings.now_playing_text"
                        }
                      ],
                      staticClass: "text-black w-full",
                      attrs: {
                      ...
                      domProps: { value: _vm.settings.now_playing_text },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _c("div", { staticClass: "mb-5" }, [
                    _c(
                      ...
                      [
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings.show_dolby_atmos_horizontal,
                              expression: "settings.show_dolby_atmos_horizontal"
                            }
                          ],
                          staticClass: "text-black",
                          attrs: { type: "checkbox" },
                        ...
                        _vm._v(
                          "\n                                Show Dolby Atmos Horizontal Logo"
                        )
                      ]
                    ),
                    _vm._v(" "),
                    _c(
                      ...
                      [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings.show_dolby_atmos_vartical,
                              expression: "settings.show_dolby_atmos_vartical"
                            }
                          ],
                          staticClass: "text-black",
                          attrs: { type: "checkbox" },
                          domProps: {
                            checked: Array.isArray(
                              _vm.settings.show_dolby_atmos_vartical
                            )
                              ? _vm._i(
                                  _vm.settings.show_dolby_atmos_vartical,
                                  null
                          ...
                          on: {
                            change: function($event) {
                              var $$a = _vm.settings.show_dolby_atmos_vartical,
                                $$el = $event.target,
                                $$c = $$el.checked ? true : false
                              if (Array.isArray($$a)) {
                                var $$v = null,
                        ...
                        _vm._v(
                          "\n                                Show Dolby Atmos Vertical Logo"
                        )
                      ]
                    ),
                    _vm._v(" "),
                    _c(
                      ...
                      [
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings.show_dolby_vision_horizontal,
                              expression:
                                "settings.show_dolby_vision_horizontal"
                            }
                          ],
                          staticClass: "text-black",
                          attrs: { type: "checkbox" },
                        ...
                        _vm._v(
                          "\n                                Show Dolby Vision Horizontal Logo"
                        )
                      ]
                    ),
                    _vm._v(" "),
                    _c(
                      ...
                      [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings.show_dolby_vision_vertical,
                              expression: "settings.show_dolby_vision_vertical"
                            }
                          ],
                          staticClass: "text-black",
                          attrs: { type: "checkbox" },
                          ...
                          on: {
                            change: function($event) {
                              var $$a = _vm.settings.show_dolby_vision_vertical,
                                $$el = $event.target,
                                $$c = $$el.checked ? true : false
                              if (Array.isArray($$a)) {
                                var $$v = null,
                        ...
                        _vm._v(
                          "\n                                Show Dolby Vision Vertical Logo"
                        )
                      ]
                    ),
                    _vm._v(" "),
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings.show_dts,
                              expression: "settings.show_dts"
                            }
                          ],
                          staticClass: "text-black",
                          attrs: { type: "checkbox" },
                          domProps: {
                            checked: Array.isArray(_vm.settings.show_dts)
                              ? _vm._i(_vm.settings.show_dts, null) > -1
                              : _vm.settings.show_dts
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.settings.show_dts,
                                $$el = $event.target,
                                $$c = $$el.checked ? true : false
                              if (Array.isArray($$a)) {
                                var $$v = null,
                                ...
                                _vm.$set(_vm.settings, "show_dts", $$c)
                              }
                            }
                          }
                        }),
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings.show_imax,
                              expression: "settings.show_imax"
                            }
                          ],
                          staticClass: "text-black",
                          attrs: { type: "checkbox" },
                          domProps: {
                            checked: Array.isArray(_vm.settings.show_imax)
                              ? _vm._i(_vm.settings.show_imax, null) > -1
                              : _vm.settings.show_imax
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.settings.show_imax,
                                $$el = $event.target,
                                $$c = $$el.checked ? true : false
                              if (Array.isArray($$a)) {
                                var $$v = null,
                                ...
                                _vm.$set(_vm.settings, "show_imax", $$c)
                              }
                            }
                          }
                        }),
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.settings.show_auro_3d,
                              expression: "settings.show_auro_3d"
                            }
                          ],
                          staticClass: "text-black",
                          attrs: { type: "checkbox" },
                          domProps: {
                            checked: Array.isArray(_vm.settings.show_auro_3d)
                              ? _vm._i(_vm.settings.show_auro_3d, null) > -1
                              : _vm.settings.show_auro_3d
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.settings.show_auro_3d,
                                $$el = $event.target,
                                $$c = $$el.checked ? true : false
                              if (Array.isArray($$a)) {
                                var $$v = null,
                                ...
                                _vm.$set(_vm.settings, "show_auro_3d", $$c)
                              }
                            }
                          }
                        }),
                  ...
                  _c("div", { staticClass: "mb-5" }, [
                    _c(
                      ...
                      {
                        staticClass: "text-gray-300 block mb-2 font-bold",
                        attrs: { for: "start-power-time" }
                      },
                      [_vm._v("Display Start Time")]
                    ),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.settings.start_power_time,
                          expression: "settings.start_power_time"
                        }
                      ],
                      staticClass: "text-black w-full",
                      attrs: {
                      ...
                      domProps: { value: _vm.settings.start_power_time },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _c("div", { staticClass: "mb-5" }, [
                    ...
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.settings.end_power_time,
                          expression: "settings.end_power_time"
                        }
                      ],
                      staticClass: "text-black w-full",
                      attrs: {
                      ...
                      domProps: { value: _vm.settings.end_power_time },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "text-gray-400 text-sm", attrs: { id: "tokenHelp" } },
      [
        _vm._v(
