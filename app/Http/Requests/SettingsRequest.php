...
class SettingsRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'require_login' => 'required|boolean',
            ...
            'theater_name_full_width' => 'required|boolean',
            'header_style' => 'required|in:plain,rules,marquee,plaque,neon',
            'header_full_width' => 'required|boolean',
            'header_position' => 'required|in:top,bottom',
    ...
    protected function prepareForValidation()
    {
        $this->merge([
            ...
            'theater_name_full_width' => $this->boolean('theater_name_full_width'),
            'header_style' => $this->input('header_style') ?: 'plain',
            'header_full_width' => $this->boolean('header_full_width'),
            'header_position' => $this->input('header_position') ?: 'top',
